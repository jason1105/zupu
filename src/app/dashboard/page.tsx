...
import DiscoverFamilies from '@/components/family/DiscoverFamilies'
  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-12">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-stone-500 text-sm mt-1">您管理的家族族谱</p>
            </div>
            <Link
              href="/families/new"
          ...
          {families.length === 0 ? (
            <div className="text-center py-16 text-stone-400 bg-stone-50 rounded-xl">
        ...
        {/* 发现家族 */}
        <section>
          <DiscoverFamilies currentUserId={session.user.id} />
        </section>
      </main>
    </>
  )
